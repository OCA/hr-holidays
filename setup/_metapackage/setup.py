...
setuptools.setup(
    ...
    version=version,
    install_requires=[
        'odoo-addon-hr_holidays_calendar_event_privacy>=15.0dev,<15.1dev',
        'odoo-addon-hr_holidays_leave_self_approve>=15.0dev,<15.1dev',
        ...
        'odoo-addon-hr_holidays_public_overtime>=15.0dev,<15.1dev',
